...
Supports running in local repo, IDEs, and directly in Google Colab via cloud URL fallback.
"""
...
# Standard robust data loader lines for all notebooks
DATA_LOAD_LINES = [
    "import os",
    "from pathlib import Path",
    "import pandas as pd",
